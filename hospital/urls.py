...
urlpatterns = [
    ...
    path('doctor_adm/',views.doctor_all_view,name='doctor_adm.html'),
    ...
    path('home_worker', views.home_worker, name = "home_worker"),
    path('doctor_confirmed/<int:pk>', views.doctor_confirmed, name = "doctor_confirmed"),
