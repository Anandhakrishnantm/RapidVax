...
from .models import Doctor,Admin,Patient,Appointment,PatHealth,PatAdmit,Charges,Medicines,DoctorProfessional,OperationCosts,ChargesApt,CovidVaccination, Worker
